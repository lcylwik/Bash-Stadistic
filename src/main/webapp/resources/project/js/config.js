materialAdmin
    .config(function ($stateProvider, $urlRouterProvider) {
        ...
        //------------------------------
            ...
            //Emisor
            .state('tableEmisorDay', {
                url: '/emisor-day',
                templateUrl: 'template/emisor-day/dashboard-table-emisor-ByDay.html',
                controller: 'emisorController',
                controllerAs: 'tctrl'
            }).state('tableEmisorDay.table', {
            url: '/table',
            templateUrl: 'template/emisor-day/dashboard-table-emisor-ByDay.table.html'
        }).state('tableEmisorDay.grafica', {
            url: '/grafica',
            templateUrl: 'template/emisor-day/dashboard-table-emisor-ByDay.grafica.html'
        }).state('tableEmisorDay.porcent', {
            url: '/porcent',
            templateUrl: 'template/emisor-day/dashboard-table-emisor-ByDay.porcent.html'
        }).state('tableEmisorDay.porcentEmisor', {
            url: '/porcentCodigo',
            templateUrl: 'template/emisor-day/dashboard-table-emisor-ByDay.porcentEmisor.html'
        })



        //Fuentes Organizadas
            .state('tableFuentesDay', {
                url: '/fuente-day',
                templateUrl: 'template/fuente-day/dashboard-table-fuentes-ByDay.html',
                controller: 'fuenteByDayController',
                controllerAs: 'tctrl'
            })
            .state('tableFuentesDay.table', {
                url: '/table',
                templateUrl: 'template/fuente-day/dashboard-table-fuentes-ByDay.table.html'
            })
            .state('tableFuentesDay.grafica', {
                url: '/grafica',
                templateUrl: 'template/fuente-day/dashboard-table-fuentes-ByDay.grafica.html'
            })
            ...
            .state('codRespTable', {
                url: '/cod-resp',
                templateUrl: 'template/cod-resp/dashboard-table-cod-resp.html',
                controller: 'codRespController',
                controllerAs: 'tctrl'
            }).state('codRespTable.table', {
            url: '/table',
            templateUrl: 'template/cod-resp/dashboard-table-cod-resp.table.html'
        }).state('codRespTable.grafica', {
            url: '/grafica',
            templateUrl: 'template/cod-resp/dashboard-table-cod-resp.grafica.html'
        }).state('codRespTable.porcent', {
            url: '/porcent',
            templateUrl: 'template/cod-resp/dashboard-table-cod-resp.porcent.html'
        }).state('codRespTable.porcentCodigo', {
            url: '/porcentCodigo',
            templateUrl: 'template/cod-resp/dashboard-table-cod-resp.porcentCodigo.html'
        })


        //Horas
            .state('codRespTableHours', {
                url: '/cod-respByHours',
                templateUrl: 'template/cod-respByHours/dashboard-table-cod-respByHours.html',
                controller: 'codRespByHoursController',
                controllerAs: 'tctrl'
            }).state('codRespTableHours.table', {
            url: '/table',
            templateUrl: 'template/cod-respByHours/dashboard-table-cod-respByHours.table.html'
        }).state('codRespTableHours.grafica', {
            url: '/grafica',
            templateUrl: 'template/cod-respByHours/dashboard-table-cod-respByHours.grafica.html'
        }).state('codRespTableHours.porcentDia', {
            url: '/porcentDia',
            templateUrl: 'template/cod-respByHours/dashboard-table-cod-respByHours.porcentDia.html'
        }).state('codRespTableHours.porcentCodigo', {
            url: '/porcentCodigo',
            templateUrl: 'template/cod-respByHours/dashboard-table-cod-respByHours.porcentCodigo.html'
        })
        ...
        //------------------------------
            ...
            .state('charts', {
                url: '/charts',
                templateUrl: 'template/dashboard-charts.html',
