materialAdmin
    ...
    .controller('materialadminCtrl', function($timeout, $state, $scope, growlService){
        //Welcome Message
        growlService.growl('Bienvenido al Estadistico de Prosa!', 'inverse')
    ...
    // Header
    // =========================================================================
    .controller('headerCtrl', function($timeout, notificationService, $scope, messageService, $localStorage, $rootScope){
        var ctrl = this;
        //$localStorage.Message = [];
        //$rootScope.messages = $localStorage.Message;

        this.deleteAll = notificationService.deleteAll();
        this.deleteItem = notificationService.delete();
